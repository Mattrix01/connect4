...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // all the different arrays for winning the game 4 in a row
  const winningArrays = [
    [0, 1, 2, 3],
    [41, 40, 39, 38],
    [7, 8, 9, 10],
  ...
  // going through each list in arrays
  function checkBoard() {
    for (let y = 0; y < winningArrays.length; y++) {
      // going into winningArray and grabbing first item etc, 4 because we are checking for 4 matches.
